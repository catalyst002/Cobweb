...
const ChatRoomUI: React.FC = () => {
  const divRef = useRef<HTMLDivElement>(null);
  const socketRef = useRef<Socket | null>(null);
  const ENDPOINT = 'https://cobwebbackendinfra.xyz:6216/';
    ...
    <div className="relative bg-yellow-50 overflow-hidden h-screen w-screen">
      ...
      <main className="ml-40 max-h-screen overflow-auto w-screen">
        <div className="max-w-5xl mx-auto">
          <div className="p-2 sm:p-6 flex flex-col h-screen justify-between">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex flex-col leading-tight">
                  ...
                  <span className="text-lg text-gray-600">
                    {users.length > 1 ? `${users.length} members` : `${users.length} member`} online
                  </span>
                </div>
              </div>
            ...
            <div id="messages" ref={divRef} className="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-yellow scrollbar-thumb-rounded scrollbar-track-yellow-lighter scrollbar-w-2 scrolling-touch">
