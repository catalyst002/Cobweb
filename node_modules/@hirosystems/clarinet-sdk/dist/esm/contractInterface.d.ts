...
export type ContractInterfaceAtomType = "none" | "int128" | "uint128" | "bool" | "principal" | {
    buffer: {
        length: number;
    };
} | {
...
export type ContractInterfaceFunctionArg = {
    name: string;
    type: ContractInterfaceAtomType;
};
export type ContractInterfaceFunctionOutput = {
    type: ContractInterfaceAtomType;
};
...
export type ContractInterfaceFungibleTokens = {
    name: string;
};
export type ContractInterfaceNonFungibleTokens = {
    name: string;
    type: ContractInterfaceAtomType;
};
export type StacksEpochId = "Epoch10" | "Epoch20" | "Epoch2_05" | "Epoch21" | "Epoch22" | "Epoch23" | "Epoch24";
