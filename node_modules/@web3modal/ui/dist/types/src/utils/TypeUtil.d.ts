...
export type TextType = 'large-500' | 'large-600' | 'large-700' | 'medium-600' | 'medium-title-600' | 'micro-600' | 'micro-700' | 'mini-700' | 'paragraph-400' | 'paragraph-500' | 'paragraph-600' | 'paragraph-700' | 'small-400' | 'small-500' | 'small-600' | 'tiny-400' | 'tiny-500' | 'tiny-600' | '2xl-500';
